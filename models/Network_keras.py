...
def BCDU_net_D3(input_size):
    ...
    up6 = Conv2DTranspose(256, kernel_size=2, strides=2, padding='same',
    ...
    up7 = Conv2DTranspose(128, kernel_size=2, strides=2, padding='same',
                          kernel_initializer='he_normal')(conv6)
    ...
    up8 = Conv2DTranspose(64, kernel_size=2, strides=2, padding='same',
                          kernel_initializer='he_normal')(conv7)
...
def BCDU_net_D1(input_size):
    ...
    x2 = Reshape(target_shape=(1, N, N, 64))(up8)
    merge8 = concatenate([x1, x2], axis=1)
    merge8 = ConvLSTM2D(filters=32, kernel_size=(3, 3),
